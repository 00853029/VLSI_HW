set sdc_version 1.2
current_design top
create_clock [get_ports {cpu_clk}] -name cpu_clk -period 20.0 -waveform {0 10.0}
...
# cpu_clk
set_input_delay  -max 10.0  -clock cpu_clk [remove_from_collection [all_inputs] [get_ports {cpu_clk}]]
set_input_delay  -min 0.0  -clock cpu_clk [remove_from_collection [all_inputs] [get_ports {cpu_clk}]]
set_output_delay -max 10.0  -clock cpu_clk [all_outputs]
